...
def add_project():
    form = AddProjectForm()
    if form.validate_on_submit():
        project = Project(body=form.body.data, describe=form.describe.data, type=form.type.data, view = form.view.data, max_students = form.max_students.data, name =form.name.data)
